...
export default class SelfSelect extends Select {
    ...
    componentDidUpdate(prevProps) {
        ...
        if (!isEqual(this.props.value, prevProps.value)) {
            ...
            this.onExactSearch(this.props.value);
        }

        if (!isEqual(this.props.params, prevProps.params)) {
            this.setState({ params: this.props.params }, this.queryList);
        }

        if (!isEqual(this.props.funcName, prevProps.funcName)) {
            this.setState({ funcName: this.props.funcName }, this.queryList);
        }

        if (this.props.list && !isEqual(this.props.list, prevProps.list)) {
    ...
    onChange = (value, option) => {
        ...
        this.setState({ value }, () => onChange && onChange(value, option, item));
    };
